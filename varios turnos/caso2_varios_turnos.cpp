...
//creacion de los platos, se modifica el intrupt y se decrementa en la linea 72
#include <iostream>
#include <mutex>
#include <thread>
#include <ctime>
...
//int intrupt = 50;
int intrupt[num_Phil];//platos con una cierta cantidad de fideos
...
void think(int id){ 
    ...
    if(ate[id]<=100 && piensa>=1050){
    	print("Philosopher " + to_string(id) + " ha muerto de hambre");
	}
}
